...
class DynamixelIO:
    ...
    def new_mx_2(self, dxl_id, protocol=2):
        ...
        return DynamixelMotor(dxl_id, self, "DynamixelJSON/MX_Protocol_2.json", protocol, 2)

    def new_mx12_1(self, dxl_id):
        """Returns a new DynamixelMotor object for an MX12"""
        return DynamixelMotor(dxl_id, self, "DynamixelJSON/MX12_28_Protocol_1.json")
    ...
    def new_mx64_1(self, dxl_id):
        ...
        return DynamixelMotor(dxl_id, self, "DynamixelJSON/MX64_Protocol_1.json")

    def new_mx106_1(self, dxl_id):
        """Returns a new DynamixelMotor object for an MX106"""
        return DynamixelMotor(dxl_id, self, "DynamixelJSON/MX106_Protocol_1.json")
